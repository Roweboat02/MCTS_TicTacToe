...
class ExplanationButton extends StatefulWidget {
  List<Explination> explinations;
  ExplanationButton(this.explinations, {Key? key}) : super(key: key);
...
class _ExplanationButtonState extends State<ExplanationButton> {
  ...
  Color get _buttonColor => open ? Colors.white : Colors.grey;
  ...
  Widget _body() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          color: Color(0x2B111520)),
      child: ListView(children: widget.explinations, shrinkWrap: true),
    );
  }
    ...
    return Row(children: [
      Align(
        ...
        child: FloatingActionButton(
          child: Icon(Icons.help_rounded, color: _buttonColor),
          onPressed: _toggleOpen,
        ),
      ),
      Align(alignment: Alignment.center, child: _body()),
    ]);
  }
}

class Explination extends StatelessWidget {
  final String title;
  final String body;

  const Explination(this.title, this.body, {Key? key}) : super(key: key);
...
String mctsTitle = 'MCTS';
String mctsExplination = """
